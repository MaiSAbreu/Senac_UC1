...
public class Formulario extends JFrame {
	...
	public Formulario() {
		...
		JLabel dobJLabel = new JLabel("Data de nascimento: ");
		...
		//As opções de gênero do formulário.
		...
		JLabel newsletterJLabel = new JLabel("Assinar newsletter: ");
		newsletterCheckBox = new JCheckBox();
		
		
		//Adicionando label e entrada de dados ao painel de formulário de dados.
